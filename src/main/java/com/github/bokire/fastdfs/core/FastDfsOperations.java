...
public interface FastDfsOperations {
	 ...
	 * 上传文件
	 *
	 * @param local_filename -- 本地需要上传的文件名
	 * @param file_ext_name -- 文件扩展名，不包括(.),null时去local_filename的扩展名
	 * @param meta_list -- 文件属性列表
	 ...
	 * 上传文件
	 *
	 * @param group_name -- 指定storageServer组名
	 * @param local_filename -- 本地需要上传的文件名
	 * @param file_ext_name -- 文件扩展名，不包括(.),null时取local_filename的扩展名
	 * @param meta_list -- 文件属性列表
	 * @return -- 返回fileId则success，null则false
	 * @throws IOException
	 * @throws MyException
	 ...
	 * @param callback -- callback对象，数据到达时会调用callback.recv()详见官方API
	 * @param file_ext_name -- 文件扩展名，不包括(.)
	 * @param meta_list -- 文件属性列表
	 * @return -- 返回fileId则success，null则false
	 * @throws IOException
	 ...
	 * 上传从文件
	 *
	 * @param master_file_id -- 主文件fileId
	 * @param prefix_name -- 从文件名
	 * @param local_filename -- 本地需要上传的从文件名
	 * @param file_ext_name -- 文件扩展名，不包括（.）,null时取local_filename的扩展名
	 * @param meta_list 文件属性列表
	 * @return -- 返回fileId则success，null则false
	 * @throws IOException
	 ...
	 * 追加上传文件
	 *
	 * @param appender_file_id -- appender文件fileId
	 * @param local_filename -- 追加上传文件的文件名
	 ...
	 *
	 * @param appender_file_id -- appender文件fileId
	 * @param file_offset -- appender文件开始修改的位置
	 ...
	 * @param file_offset -- appender文件开始修改的位置
	 * @param file_buff -- 修改的文件内容
	 * @param buffer_offset -- 修改内容开始位置
	 * @param buffer_length -- 修改内容长度
	 * @return -- 返回0则success，!=0则false
	 * @throws IOException
	 * @throws MyException
	 */
